...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	$sql = "SELECT * FROM car_Customers WHERE email = ? AND password = ? LIMIT 1";
	$q = $pdo->prepare($sql);
	...
	if($data) { // if successful login set session variables
		...
		$_SESSION['title'] = "customer"; //recognizing title
		Database::disconnect();
		header("Location: orders.php"); //need to use GET or no? seems kinda dumb
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<div class="row">
				<h3>Auto Store Customer Login</h3>
			</div>
			...
			<form class="form-horizontal" action="login.php" method="post">
				...
				<div class="form-actions">
					...
					&nbsp; &nbsp;
					<a class="btn btn-primary" href="customers_create.php">Register</a>
				</div>
				
				<p><a href="employees_create.php">Register as Employee</a></p>
				<p><a href="login_employee.php">Login as Employee</a></p>
